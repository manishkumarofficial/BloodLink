...
data class FDonationCamp(
    ...
    val organizationRegistrationNumber: String = "",
    val bloodBankLicenseNumber: String = "",
    val hospitalRegistrationNumber: String = "",
    val governmentApprovalNumber: String = "",
    ...
    val expectedDonors: Int = 0,
    val participantsCount: Int = 0,
    val maxParticipants: Int = 100,
    val maximumParticipants: Int = 100,
    val requiredBloodGroups: List<String> = emptyList(),
    val status: String = "Upcoming", // "Upcoming", "Active", "Cancelled", "Completed"
